    ...
    <form role="form" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="name" placeholder="Phone" name="mobile" value="{{ $user->mobile }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="Username" name="username" value="{{ $user->username }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="Address" name="address" value="{{ $user->profile->address }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="Designation" name="designation" value="{{ $user->profile->designation }}">
